...
SECRET_KEY = 'django-insecure-bs-d(p)_t0gmvfj7+g#k1n(&#o&m#@te&bv57n6wk)iajw%9b$'
...
INSTALLED_APPS = [
    ...
    "post_2.apps.Post2Config",                         #aqui se registra la app post_2
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],              #aqui se regitro el template
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
